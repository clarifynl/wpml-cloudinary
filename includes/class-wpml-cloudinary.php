...
class WPML_Cloudinary {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $wpml_cloudinary    The string used to uniquely identify this plugin.
	 */
	protected $wpml_cloudinary;
	...
	public function __construct() {
		...
		$this->wpml_cloudinary = 'wpml-cloudinary';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpml-cloudinary-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpml-cloudinary-i18n.php';
	 ...
	 *
	 * Uses the wpml_cloudinary_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'updated_attachment_meta', $plugin_admin, 'updated_attachment_meta', 10, 4 );
	 ...
	 */
	public function get_wpml_cloudinary() {
		return $this->wpml_cloudinary;
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    wpml_cloudinary_Loader    Orchestrates the hooks of the plugin.
	 */
